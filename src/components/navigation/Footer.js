    ...
    return (
        <footer className="bg-gray-50 dark:bg-gray-900" aria-labelledby="footer-heading">       
            <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="text-center xl:grid xl:grid-cols-3 xl:gap-8">
                    <Link to="/" className="inline-block justify-center nav-link space-y-8 xl:col-span-1">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <a key={item.name} href={item.href} className="footerDescription">
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                        <h3 className="footerTitle">Visit Us</h3>
                        <ul role="list" className="mt-4 space-y-4">
                            {navigation.solutions.map((item) => (
                            <li key={item.name}>
                                <a href={item.href} className="footerDescription">
                                {item.name}
                                </a>
                            </li>
                            ))}
                        ...
                        <h3 className="footerTitle">Call Us</h3>
                        <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="footerDescription text-center">&copy; 2023 RTR, Inc. All rights reserved.</p>
                </div>
            </div>
