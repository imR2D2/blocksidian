        ...
        <div className='flex items-center'>
          ...
          <Fade left>
            ...
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold leading-normal dark:text-whitee-900'>
              ...
              events with <br />
              <span className='bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-purple-800'>Blocksidian</span>
            </h1>

            <div className="mt-4 mb-8">
              <p className="text-gray dark:text-whitee-900">Buy, sell and enjoy your tickets with total confidence and transparency!</p>
            </div>
