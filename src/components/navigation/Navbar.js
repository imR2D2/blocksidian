...
const Navbar = () => {
    ...
    return (
        <div id="navbar" className="fixed bg-white dark:bg-black w-full top-0 z-50 px-4 py-5 transition duration-300">
            <div  className="ml-6 -mt-3 flex flex-wrap items-center sm:flex-nowrap">
                ...
                <div id="menu" className="hidden md-1:block ml-4 mt-2 flex-shrink-0">
                    ...
                    <NavLink to="/contacto" className="navBar">Contact</NavLink>
                    <a download='CV_Arturo Hernández Bueno' href={cv}>
                        <button type="button" className="text-sm border-2 rounded-full px-6 py-1.5 ml-3 font-medium text-purple-400 border-purple-400 hover:bg-purple-800 hover:border-purple-800 hover:text-white dark:hover:text-black dark:text-white transition duration-700">
                            Sign Up
                        </button>
                    </a>
                    <a download='CV_Arturo Hernández Bueno' href={cv}>
                        <button type="button" className="text-sm border-2 rounded-full px-8 py-2 ml-3 border-none font-medium text-white bg-purple-400 hover:bg-purple-800 transition duration-700">
                            Log In
                        </button>
                    </a>
                </div>
